import { ActionRowBuilder, ButtonBuilder, ButtonInteraction, ButtonStyle, CacheType, ComponentType, InteractionCollector, Message } from "discord.js";
...
export class PaginationRowBuilder extends ActionRowBuilder<ButtonBuilder> {
	...
	public handleAction(action: "first" | "back" | "next" | "last") {
